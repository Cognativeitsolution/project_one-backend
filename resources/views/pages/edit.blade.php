...
@section('content')
  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <div class="col-sm-4">
              <a href="{{ route('pages.index') }}" class="btn btn-block btn-primary">View Pages</a>
            </div>
    ...
    <div class="container mt-4">
      ...
      <div class="card">    
        <div class="card-body">
          <form name="edit-page-post-form" id="edit-page-post-form" method="post" enctype="multipart/form-data" action="{{ route('pages.update', $record->id) }}">
          @method('PATCH')
          @csrf
          <div class="row">
            ...
            <div class="form-group">
              ...
              <select name="parent_id" class="form-control" data-placeholder="Select a Parent" >
                ...
                @foreach($pages as $page)
                  <option value={{ $page->id }} <?php if(in_array($page->id, [$record->parent_id])){
                    echo 'selected';
                  }?> >{!! Str::words( $page->title, 5, ' ..') !!}</option>
                @endforeach
