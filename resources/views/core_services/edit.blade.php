...
@section('content')
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Edit Core Service</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="container mt-4">
      ...
      <div class="card">    
        <div class="card-body">
          <form name="edit-core-service-form" id="edit-core-service-form" method="post" enctype="multipart/form-data" action="{{ route('core_services.update', $record->id) }}">
          @method('PATCH')
          @csrf
          <div class="row">
            ...
            <div class="form-group">
              <label for="image">Core Service Image</label>
            ...
            <div class="form-group col-md-6 col-sm-6 col-lg-6 col-xs-6">
              ...
              <br/>
              <img src="{{ url('/images/') }}/{{ $record->image }}" >
            </div>
            @endif
