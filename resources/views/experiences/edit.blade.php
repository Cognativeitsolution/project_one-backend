      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <div class="col-sm-4">
              <a href="{{ route('experiences.index') }}" class="btn btn-block btn-primary">View Experiences</a>
            </div>
    ...
    <div class="container mt-4">
      ...
      <div class="card">    
        <div class="card-body">
          ...
          <form name="edit-experience-post-form" id="edit-experience-post-form" method="post" action="{{ route('experiences.update', $experience->id) }}">
            @method('PATCH')
            @csrf
            <div class="row">
              ...
              <div class="form-group">
                <div class="custom-control custom-switch">
                  <input type="checkbox" name="status" {{ $experience->status == 1 ? 'checked' : 'no' }} class="custom-control-input" id="customSwitch1">
